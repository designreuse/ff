...
public class GfiSyncSpecification implements Specification<GfiSync> {

	private SearchCriteria criteria;

	public GfiSyncSpecification(final SearchCriteria criteria) {
		super();
	...
	@Override
	public Predicate toPredicate(Root<GfiSync> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
