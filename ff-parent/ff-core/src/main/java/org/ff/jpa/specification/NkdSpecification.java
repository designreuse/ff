...
public class NkdSpecification implements Specification<Nkd> {

	private SearchCriteria criteria;

	public NkdSpecification(final SearchCriteria criteria) {
		super();
	...
	@Override
	public Predicate toPredicate(Root<Nkd> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
