...
public class Subdivision1Specification implements Specification<Subdivision1> {

	private SearchCriteria criteria;

	public Subdivision1Specification(final SearchCriteria criteria) {
		super();
	...
	@Override
	public Predicate toPredicate(Root<Subdivision1> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
