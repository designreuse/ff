...
public class UserGroupSpecification implements Specification<UserGroup> {
	...
	public UserGroupSpecification(final SearchCriteria criteria) {
		super();
	...
	@Override
	public Predicate toPredicate(Root<UserGroup> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
