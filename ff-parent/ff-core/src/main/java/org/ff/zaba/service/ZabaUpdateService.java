...
public class ZabaUpdateService {
	...
	private void updateLegalTypeNumber(Company company, ZabaCompanyResource resource, boolean forceUpdate) throws Exception {
	...
	private void updateZipCode(Company company, ZabaCompanyResource resource, boolean forceUpdate) throws Exception {
	...
	private void updateFoundingDate(Company company, ZabaCompanyResource resource, boolean forceUpdate) throws Exception {
	...
	private void updateBankruptcyProcedure(Company company, ZabaCompanyResource resource, boolean forceUpdate) throws Exception {
	...
	private void updateBlocked5Days(Company company, ZabaCompanyResource resource, boolean forceUpdate) throws Exception {
	...
	private void updateBlocked20Days(Company company, ZabaCompanyResource resource, boolean forceUpdate) throws Exception {
	...
	private void updateNumberOfEmployees(Company company, ZabaCompanyResource resource, boolean forceUpdate) throws Exception {
	...
	private void updateLastYearIncome(Company company, ZabaCompanyResource resource, boolean forceUpdate) throws Exception {
	...
	private void updateProfitBeforeTax(Company company, ZabaCompanyResource resource, boolean forceUpdate) throws Exception {
	...
	private void updateProfitOrLoss(Company company, ZabaCompanyResource resource, boolean forceUpdate) throws Exception {
	...
	private void updateCapitalTotalLiabilities(Company company, ZabaCompanyResource resource, boolean forceUpdate) throws Exception {
