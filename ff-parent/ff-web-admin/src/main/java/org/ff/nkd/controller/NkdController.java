...
public class NkdController extends BaseController {
	...
	public PageableResource<NkdResource> getPage(@RequestBody UiGridResource resource) {
	...
	public NkdResource find(@AuthenticationPrincipal UserDetails user, @PathVariable Integer id, HttpServletRequest request) {
	...
	public NkdResource save(@AuthenticationPrincipal UserDetails user, @RequestBody NkdResource resource, HttpServletRequest request) {
