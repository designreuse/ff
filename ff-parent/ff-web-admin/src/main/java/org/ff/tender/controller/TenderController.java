...
public class TenderController extends BaseController {
	...
	public TenderResource find(@AuthenticationPrincipal UserDetails user, @PathVariable Integer id, HttpServletRequest request) {
	...
	public TenderResource save(@AuthenticationPrincipal UserDetails user, @RequestBody TenderResource resource, HttpServletRequest request) {
	...
	public TenderResource activate(@AuthenticationPrincipal UserDetails user, @PathVariable Integer id, HttpServletRequest request) {
	...
	public TenderResource deactivate(@AuthenticationPrincipal UserDetails user, @PathVariable Integer id, HttpServletRequest request) {
