function config($translateProvider) {
	$translateProvider
		.translations('hr', {
			...
			MENU_CONFIG_PARAMS: 'Konfiguracijski parametri',
			...
			MENU_EMAIL: 'E-mail',
			MENU_GFI_SYNCS: 'Povijest GFI sinkronizacija',
			...
			HEADER_CONFIG_PARAMS: 'Konfiguracijski parametri',
			...
			HEADER_GFI_SYNC_DETAILS: 'Detalji o GFI sinkronizaciji',
			...
			LABEL_GFI_SYNC_NOK_USERS: 'Lista korisnika za koje je GFI sinkronizacija bila neuspješna',
			...
			COLUMN_EMAIL: 'E-mail',
			COLUMN_END_TIME: 'Vrijeme završetka',
			COLUMN_FIRST_NAME: 'Ime',
			COLUMN_FIRST_AND_LAST_NAME: 'Ime i prezime',
			COLUMN_GFI_SYNC_TOTAL: 'Ukupno sinkroniziranih korisnika',
			COLUMN_GFI_SYNC_OK: 'Uspješno sinkroniziranih korisnika',
			COLUMN_GFI_SYNC_NOK: 'Neuspješno sinkroniziranih korisnika',
			COLUMN_ID: 'ID',
			...
			COLUMN_START_TIME: 'Vrijeme početka',
			...
			BUTTON_SEND: 'Pošalji',
			BUTTON_YES: 'Da',
			BUTTON_GFI_HISTORY: 'Povijest GFI sinkronizacija',
			BUTTON_EXPORT: 'Izvoz',
