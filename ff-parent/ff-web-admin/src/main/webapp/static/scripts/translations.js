function config($translateProvider) {
	$translateProvider
		.translations('en', {
			...
			LABEL_TENDERS_4_PROJECT: 'Tenders that are a match for this project',
			...
			COLUMN_CONTACT_TOPIC: 'Topic',
			COLUMN_CONTACT_TYPE: 'Type',
			COLUMN_CONTACT_CHANNEL: 'Channel',
			...
			COLUMN_INVESTMENT_VALUE_TOTAL: 'Investments value',
			...
			COLUMN_NO_OF_INVESTMENTS: 'Number of investments',
			COLUMN_OPERATOR: 'Operator',
			COLUMN_ORG_UNIT: 'Organization unit',
			...
			ERR_MSG_001: 'Company item with meta tag {{metatag}} not found',
			ERR_MSG_002: 'Meta tag {{metatag}} found in more then one company item',
