function config($translateProvider) {
	$translateProvider
		...
		.translations('hr', {
			...
			ACTION_SYNC_DATA_ALWAYS_SUCCESS_MESSAGE: 'Podaci o poduzeću su uspješno ažurirani, te će i ubuduće biti automatski ažurirani',
			...
			LABEL_SYNC_DATA_WARNING: 'Podaci o poduzeću koje ste unijeli se razlikuju od podataka koje ima banka. Molimo odaberite akciju.',
			...
			TOOLTIP_SYNC_DATA: 'Ažuriraj podatke o poduzeću koje ste unijeli sa podacima koje ima banka',
			TOOLTIP_SYNC_DATA_ALWAYS: 'Ažuriraj podatke o poduzeću koje ste unijeli sa podacima koje ima banka sad i ubuduće',
